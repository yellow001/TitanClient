...
public class UTweenAllEditor : UGUITweenEditor {
    ...
    public void TweenAllBaseGUI() {

        UTweenAll t = target as UTweenAll;
        #region 颜色
        UIEditorHelper.BeginBox();
        t.tweenAlpha = EditorGUILayout.ToggleLeft("播放 CanvasGroup 中的 alpha 动画", t.tweenAlpha, GUILayout.MaxWidth(225));
        if (t.tweenAlpha) {
        ...
        UIEditorHelper.BeginBox();
        t.tweenColor = EditorGUILayout.ToggleLeft("播放颜色动画", t.tweenColor, GUILayout.MaxWidth(225));
        if (t.tweenColor) {
            EditorGUILayout.BeginHorizontal();
        ...
        #region 位置
        UIEditorHelper.BeginBox();
        t.tweenPos = EditorGUILayout.ToggleLeft("播放位置动画", t.tweenPos, GUILayout.MaxWidth(225));
        if (t.tweenPos) {
        ...
        #region 旋转
        UIEditorHelper.BeginBox();
        t.tweenRotate = EditorGUILayout.ToggleLeft("播放旋转动画", t.tweenRotate, GUILayout.MaxWidth(225));
        if (t.tweenRotate) {
            EditorGUILayout.BeginVertical();
        ...
        #region 缩放
        UIEditorHelper.BeginBox();
        t.tweenScale = EditorGUILayout.ToggleLeft("播放缩放动画", t.tweenScale, GUILayout.MaxWidth(225));
        if (t.tweenScale) {
            EditorGUILayout.BeginVertical();
