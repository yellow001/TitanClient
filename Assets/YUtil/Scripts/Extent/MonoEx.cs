...
public static class MonoEx{
    ...
    public static void AddTimeEvent(this MonoBehaviour mono, float t,Action overDe,Action<float,float> updateDe,int count=1,bool doNow=false)
    {
        TimeEventMgr.Ins.AddTimeEvent(new TimeEvent(t,overDe,updateDe,count,doNow));
    }
